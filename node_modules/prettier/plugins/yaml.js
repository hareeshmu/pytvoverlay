...
${e}${t.slice(A+1,_)}`)}return L}var qn=({indentAtStart:t})=>t?Object.assign({indentAtStart:t},be.fold):be.fold,jt=t=>/^(%|---|\.\.\.)/m.test(t);function Ro(t,e,n){if(!e||e<0)return!1;let r=e-n,s=t.length;if(s<=r)return!1;for(let i=0,o=0;i<s;++i)if(t[i]===`
...
`,l+=2;a+=o,i[l+2]===" "&&(a+="\\"),l+=1,c=l+1}break;default:l+=1}return a=c?a+i.slice(c):i,n?a:Wt(a,o,Ut,qn(e))}function Bs(t,e){if(e.implicitKey){if(/\n/.test(t))return Se(t,e)}else if(/[ \t]\n|\n[ \t]/.test(t))return Se(t,e);let n=e.indent||(jt(t)?"  ":""),r="'"+t.replace(/'/g,"''").replace(/\n+/g,`$&
${n}`)+"'";return e.implicitKey?r:Wt(r,n,Ys,qn(e))}function Kt({comment:t,type:e,value:n},r,s,i){if(/\n[\t ]+$/.test(n)||/^\s*$/.test(n))return Se(n,r);let o=r.indent||(r.forceBlockIndent||jt(n)?"  ":""),a=o?"2":"1",c=e===p.Type.BLOCK_FOLDED?!1:e===p.Type.BLOCK_LITERAL?!0:!Ro(n,be.fold.lineWidth,o.length),l=c?"|":">";if(!n)return l+`
...
`)===-1?o.indexOf('"')!==-1&&o.indexOf("'")===-1?Bs(o,e):Se(o,e):Kt(t,e,n,r);if(!c&&!f&&i!==p.Type.PLAIN&&o.indexOf(`
`)!==-1)return Kt(t,e,n,r);if(l===""&&jt(o))return e.forceBlockIndent=!0,Kt(t,e,n,r);let m=o.replace(/\n+/g,`$&
${l}`);if(a){let{tags:y}=e.doc.schema;if(typeof Fn(m,y,y.scalarFallback).value!="string")return Se(o,e)}let d=c?m:Wt(m,l,Ys,qn(e));return s&&!f&&(d.indexOf(`
`)!==-1||s.indexOf(`
